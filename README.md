...
Type to narrow the list, <kbd>↑</kbd>/<kbd>↓</kbd> to move, <kbd>Enter</kbd> to open the selected extension's options page in a new tab beside the current one, <kbd>Esc</kbd> to close. The shortcut can be changed at brave://extensions/shortcuts.
